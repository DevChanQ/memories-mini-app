                    ...
                    <div>
                        ...
                        <div
                            ...
                            <h1
                                ...
                                className={cn(
                                    "font-light w-full leading-tight max-h-[3.5em] overflow-hidden cursor-text text-left rounded focus:outline-2 outline-blue-400/50",
                                    // size === 'sm' ? 'text-2xl md:text-4xl min-h-[2em] md:min-h-[2.5em]' : size === 'lg' ? 'text-5xl md:text-8xl min-h-[3.5em] md:min-h-[5em]' : ''
                                )}
                                style={{
                                    marginBottom: `calc(var(--stamp-scale) * 0.5em)`,
